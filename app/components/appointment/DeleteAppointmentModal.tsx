...
export default function DeleteAppointmentModal() {
    ...
    const deleteAppointmentShow = searchParams.get('deleteAppointmentShow')
    const show = deleteAppointmentShow ? true : false

    const hideModal = new URLSearchParams(searchParams.toString())
    hideModal.delete('deleteAppointmentShow')
    hideModal.delete('deleteAppointmentId')
    return (
        <>
            <>
